...
def account_opening_email(profile, password):
    from alchemy.modules.utils import send_email

    first_name = profile.user.first_name
    email = profile.user.email
    if not profile.user.first_name:
        first_name = "Alchemy Admin"

    message = (
        f"Dear {first_name}, <br><br>Welcome to <a href='{settings.FRONTEND_URL}' target='_blank'>"
        f"Alchemy .</a><br>Please see below, your username "
        f"and password. You are advised to change your password on your first login <br><br>"
...
def send_token_to_email(user_profile):
    from alchemy.modules.utils import send_email, decrypt_text
